...
print(F+'*'*60)
ID = input(f' {C}[01] {X} DONE START BOT BY @M_M_v_M : ')

# bot session
api_id_bot = 1724716
api_hash_bot = "00b2d8f59c12c1b9a4bc63b70b461b2f"
bot = TelegramClient("Bot", api_id_bot, api_hash_bot).start(bot_token="6676279067:AAHZbyOtNqA9Nc7ZfNNnEPSF-sJXtFa6fsA")
